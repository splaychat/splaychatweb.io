# Localization guide for web-SplayChat
...
5. enjoy your awesome new web-SplayChat in your own language!

You may also want to join the project on [transifex](https://www.transifex.com/projects/p/SplayChat-web/).
...
`js/locales/en-us.json` should provide you with all the localization strings currently in use in web-SplayChat and therefore be a complete template to begin with.
...
> Please, install {chrome-link: http://google.com/chrome | Google Chrome} or use {SplayChat-link: https://SplayChat.com/ | mobile app} instead.

which would end up as

> Please, install <a href="http://google.com/chrome" target="_blank">Google Chrome</a> or use <a href="https://SplayChat.com/" target="_blank">mobile app</a> instead.
...
> "welcome_text_1_md": "This is a web-client for the **SplayChat Messenger**.",

becomes
```html
This is a web-client for the <strong>SplayChat Messenger</strong>.
```
...
The final step is to add the new locale to the list with supported (i.e. existing) locales for web-SplayChat in `Config.I18n` object in `js/lib/config.js`.
